...
class ProductoAPIView(APIView):
    ...
    def post(self, request):
        ...
        serializer = ProductoSerializer(data=datos_peticion)
        if serializer.is_valid():
            serializer.save()
            respuesta ={'mensaje':'Producto creado exitosamente','datos':serializer.data}
    ...
    def delete(self, request, id_producto):
        try:
            ...
            producto.delete()
            return Response({'mensaje':'Producto elminado exitosamente'}, status=status.HTTP_200_OK)
    ...
    def put(self, request, id_producto):
        ...
        if serializer.is_valid():
            serializer.save()
            respuesta = {'mensaje':'Producto actualizado exitosamente', 'datos': serializer.data}
...
class EmpleadoAPIView(APIView):
    ...
    def delete(self, request, id_empleado):
        try:
            ...
            empleado.delete()
            return Response({'mensaje':'Empleado elminado exitosamente'}, status=status.HTTP_200_OK)
    ...
    def put(self, request, id_empleado):
        ...
        if serializer.is_valid():
            serializer.save()
            respuesta = {'mensaje':'Empleado actualizado exitosamente', 'datos': serializer.data}
            return Response(respuesta, status=status.HTTP_200_OK)
        return Response(serializer.errors, status=status.HTTP_400_BAD_REQUEST)
...
class EmpleadoDetalleAPIView(APIView):
    permission_classes= [IsAuthenticated]
    @swagger_auto_schema(
            operation_description='Obtiene la lista de los turnos de cada empleado',
            responses={200:EmpleadoSerializer(many=True)}
    )
...
class TurnoAPIView(APIView):
    ...
    def get(self, request):
        ...
        paginated_queryset=paginator.paginate_queryset(turno,request)
    ...
    def post(self, request):
        datos_peticion = request.data
        serializer = TurnoSerializer(data=datos_peticion)
        if serializer.is_valid():
            serializer.save()
            respuesta ={'mensaje':'Turno creado exitosamente','datos':serializer.data}
            return Response(respuesta, status=status.HTTP_201_CREATED)
        return Response(serializer.errors, status=status.HTTP_400_BAD_REQUEST)
    ...
    def put(self, request, id_turno):
        ...
        if serializer.is_valid():
            serializer.save()
            respuesta = {'mensaje':'Turno actualizado exitosamente', 'datos': serializer.data}
            return Response(respuesta, status=status.HTTP_200_OK)
        return Response(serializer.errors, status=status.HTTP_400_BAD_REQUEST)
...
class ServicioAPIView(APIView):
    ...
    def post(self, request):
        datos_peticion = request.data
        serializer = ServicioSerializer(data=datos_peticion)
        if serializer.is_valid():
            serializer.save()
            respuesta ={'mensaje':'Servicio creado exitosamente','datos':serializer.data}
            return Response(respuesta, status=status.HTTP_201_CREATED)
        return Response(serializer.errors, status=status.HTTP_400_BAD_REQUEST)
    ...
    def put(self, request, id_servicio):
        ...
        if serializer.is_valid():
            serializer.save()
            respuesta = {'mensaje':'Servicio actualizado exitosamente', 'datos': serializer.data}
            return Response(respuesta, status=status.HTTP_200_OK)
        return Response(serializer.errors, status=status.HTTP_400_BAD_REQUEST)